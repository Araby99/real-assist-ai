    ...
    return (
        <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-1 text-sm">
                ...
                <textarea id="message" rows="4" className="block p-2.5 w-full bg-inherit text-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Reply to the email."></textarea>
            </div>
